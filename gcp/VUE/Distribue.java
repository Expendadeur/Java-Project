 ...
 * @author EXPENDATEUR
 */
public class Distribue extends javax.swing.JPanel {

    /**
     * Creates new form Distribue
     */
    public Distribue() {
        initComponents();
        getEnvoyesCourrierDetails();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ETAT DU COURIERS DISTRIBUE");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtPoids, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Id, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtDestination, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtMontant, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtOrigine, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtType, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addComponent(agencyComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(destinataire, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public void getEnvoyesCourrierDetails() {
    ...
    String query = "SELECT c.Id_Courrier AS Id, c.Poids_Courrier AS poids, c.Type_Courrier AS type, " +
                   ...
                   "WHERE c.Id_Agence_Destination = ? AND c.Statut = 'Envoyé'"; // Filtrer par ID d'agence et statut
    ...
    try (Connection conn = DatabaseConnection.getConnection();
        ...
        e.printStackTrace();
        JOptionPane.showMessageDialog(null, "Erreur lors de la récupération des informations des courriers envoyés.");
    }
}
  ...
  private void updateCourierStatus(int courrierId, String status, String agencyName) {
    ...
    if (confirmation == JOptionPane.YES_OPTION) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rowsAffected > 0) {
                String successMessage = "Courrier Distribué avec succès !"; // Message de succès
